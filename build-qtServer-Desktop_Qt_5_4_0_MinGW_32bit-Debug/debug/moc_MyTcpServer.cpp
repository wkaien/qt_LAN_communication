...
#include "../../qtServer/MyTcpServer.h"
...
QT_MOC_LITERAL(1, 12, 22), // "newConnectionForThread"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 7), // "qintptr"
QT_MOC_LITERAL(4, 44, 16) // "socketDescriptor"

    },
    "MyTcpServer\0newConnectionForThread\0\0"
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTcpServer::newConnectionForThread)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyTcpServer::newConnectionForThread(qintptr _t1)
{
